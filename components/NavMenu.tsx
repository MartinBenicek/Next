...
const NavMenu = ({image, text}: 
{
    ...
    return (
        <>
            <span className='relative w-10 h-10 md:hidden' onClick={openMenu}>
                <Image
                src={`/img/${image}.svg`}
                alt={text}
                fill={true}
            ...
            <div className={`md:hidden fixed top-0 right-0 h-full w-full  bg-gradient-to-r from-amber-800 via-amber-600 to-amber-800 text-white shadow-lg transform
                ...
                <div className="min-h-screen flex flex-col justify-center">
                    ...
                    <div className="flex flex-col space-y-6">
                        ...
                        <span onClick={() => handleNavigation('/pocitaniKaret')}>
                            <UvodCard text="Počítání karet" image="pocitadlo" href="pocitaniKaret" />
                        </span>
